...
Omar Santos is a Distinguished Engineer at Cisco focusing on artificial intelligence (AI) security, cybersecurity research, incident response, and vulnerability disclosure. He is the co-chair of the [Coalition for Secure AI (CoSAI)](https://www.coalitionforsecureai.org/) and was a board member of the [OASIS Open standards organization](https://www.oasis-open.org/). Omar is also the chair of the [OpenEoX](https://openeox.org) and the [Common Security Advisory Framework (CSAF)](https://oasis-open.github.io/csaf-documentation/) technical committee. His work led the creation of the [CSAF ISO standard](https://www.iso.org/standard/89986.html).
Omar was the co-chair of the [FIRST PSIRT Special Interest Group (SIG).](https://www.first.org/global/sigs/psirt/) and one of the original founders and leads of [the DEF CON Red Team Village](https://redteamvillage.io/team/).
...
- [loop: The Claude Code Command That Is Changing the Conversation about Software Engineering](https://santosomar.medium.com/loop-the-claude-code-command-that-is-changing-the-conversation-about-software-engineering-46a16eb4be30?source=rss-fc39e28d7e52------2)
